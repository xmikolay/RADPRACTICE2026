...
namespace S00254903_WebApp.Controllers
{
    ...
    public class LecturersController : Controller
    {
        ...
        public LecturersController(ConsoleStudentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            #region Q3 (c)  Amend the lecturer details page to show a list of all the courses that the lecturer is teaching.
                .Include(l => l.Courses) // Include the courses taught by the lecturer
            #endregion
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,Surname,Title,Email")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,Surname,Title,Email")] Lecturer lecturer)
        {
            if (id != lecturer.ID)
            {
                return NotFound();
